...
namespace Visualisation
{
    ...
    {
        public void Draw(List<Tuple<float, float>> points, HashSet<Tuple<float, float>> visitedStates, Transform transform, Material pathMaterial, Material pathPointsMaterial, Material visitedMaterial)
        {
        ...
        private List<Vector3> processPoints(List<Tuple<float, float>> points)
        {
            List<Vector3> pathPoints = new List<Vector3>();
            foreach (var point in points)
            {
                //Debug.Log("X: " + point.Item1 + "| Y: " + point.Item2);
        ...
        private List<Vector3> processVisitedPosSet(HashSet<Tuple<float, float>> points)
        {
